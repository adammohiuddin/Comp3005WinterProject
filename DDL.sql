...
select order_num, order_date, ISBN, quantity, price_of(ISBN, order_date)
from user_order natural join basket;


create materialized view sale_price_for_quantity(order_num, order_date, ISBN, quantity_price) as
select order_num, order_date, ISBN, quantity * price_per_book
from sales_price;


create materialized view order_costs(order_num, order_date, ISBN, quantity_price) as
select order_num, order_date, ISBN, order_qty * book_cost
from order_book;
